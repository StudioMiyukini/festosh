...
function formatFestival(f: typeof festivals.$inferSelect) {
  return {
    ...
    status: f.status,
    org_name: f.orgName ?? null,
    org_type: f.orgType ?? null,
    org_siret: f.orgSiret ?? null,
    org_rna: f.orgRna ?? null,
    org_address: f.orgAddress ?? null,
    org_phone: f.orgPhone ?? null,
    org_email: f.orgEmail ?? null,
    org_iban: f.orgIban ?? null,
    org_insurance: f.orgInsurance ?? null,
