  ...
  try {
    ...
    return c.json({
      ...
      data: {
        ...
        volunteer_skills: user.volunteerSkills ? JSON.parse(user.volunteerSkills) : [],
        locale: user.locale,
        timezone: user.timezone,
        ...
        exhibitor_profile: exhibitor_profile ? {
          ...
          social_links: exhibitor_profile.socialLinks ? JSON.parse(exhibitor_profile.socialLinks) : [],
